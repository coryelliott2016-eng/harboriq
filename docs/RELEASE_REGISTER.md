...
| Demo / lead capture | Form stores leads in Neon `harboriq-marketing` | 2026-09-22 live `POST /api/leads` returned 201 (id 2, labeled synthetic `@example.invalid`) | Cory | Lead-notification email (needs mail provider) | Test lead stored and retrievable via admin endpoint | **Live** |
